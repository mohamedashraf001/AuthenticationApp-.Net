...
namespace BusinessLayer.Services
{
    public class RoleService : IRoleService
    {
        ...
        public async Task<Role> CreateRoleAsync(CreateRoleRequest roleRequest)
        {
            ...
            var rolePermissions = roleRequest.Permissions.Select(permissionId => new RolePermission
            {
            ...
            // Fetch the role with permissions to ensure it's fully loaded
            return await _roleRepository.GetRoleByIdAsync(role.Id);
        }
